...
public abstract class Tile{
	...
	public static final Tile DOOR_TO_CAVE =		new BasicDoorTile(6, 3, 0, Colors.get(-1, 131, 000, -1), 0xFFFF00FF, "res/levels/testLevel.png");
	...
	public Tile(int id, boolean isSolid, boolean isEmitter, int levelColor, String imgPath){
		this.id = (byte) id;
		if(tiles[id] != null)
			throw new RuntimeException("Duplicate tile id on " + id);
